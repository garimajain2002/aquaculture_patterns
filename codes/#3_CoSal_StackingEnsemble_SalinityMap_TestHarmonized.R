#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#~~~~~~~~~~~ Landsat5 Harmonised Salinity Maps using Stacked Ensemble Model ~~~~~~~~~~~~#
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#non-harmonised
landsat_image <- brick("data/tif/testHarmonization/OD_1_geomedian_2007.tif")

#harmonised
landsat_image <- brick("data/tif/testHarmonization/OD_1_geomedian_2007_predicted_predicted.tif")

aqua_image <- brick("data/tif/testHarmonization/OD_1_classified_2007.tif")
boundaries <- st_read("data/shp/OD_1_AllData.shp")
#file.choose()
...
writeRaster(predicted_raster, "data/tif/testHarmonization/OD_1_geomedian_2007_ECAqua.tif", format = "GTiff", overwrite = TRUE)

# harmonised outputs show significantly less salinity than non-harmonise dimages that seemed unrealistic. 
# harmonised images are better to use. 
